...
export default function TablePedingCharge({ charges, count }) {
  return (
    <div className="card-charge-container">
      <div className="card-title-table">

        <h1>Cobranças Previstas</h1>
        <div className="card-number" style={{ backgroundColor: '#FCF6DC', color: ' #C5A605' }}>
      ...
      <Link
        onClick={() => setLocalStorage('charges', 'peding')}
        to="/charges"
